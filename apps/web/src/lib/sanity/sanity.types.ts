...
// Query: *[_type == "featureSection"] | order(_createdAt asc) {    _id,    _type,    title,    description,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(    alt,    asset->altText,    caption,    asset->originalFilename,    "untitled"  ),  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },    primaryButton,    secondaryButton,    imagePosition,    backgroundColor  }
