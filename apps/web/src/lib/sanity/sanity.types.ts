...
export type FeatureSection = {
  ...
  backgroundColor?: "cream" | "white" | "gray";
};
...
export type AllSanitySchemaTypes = SubscribeNewsletter | ImageLinkCards | FaqAccordion | FeatureCardsIcon | Cta | Hero | PageBuilder | Button | RichText | CustomUrl | FeatureSection | SanityImageCrop | SanityImageHotspot | Redirect | Slug | Navbar | Footer | Settings | BlogIndex | HomePage | Author | Faq | Page | LucideIcon | Blog | SanityAssistInstructionTask | SanityAssistTaskStatus | SanityAssistSchemaTypeAnnotations | SanityAssistOutputType | SanityAssistOutputField | SanityAssistInstructionContext | AssistInstructionContext | SanityAssistInstructionUserInput | SanityAssistInstructionPrompt | SanityAssistInstructionFieldRef | SanityAssistInstruction | SanityAssistSchemaTypeField | MediaTag | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageMetadata | SanityFileAsset | SanityAssetSourceData | SanityImageAsset | Geopoint;
...
// Variable: queryFeatureSections
// Query: *[_type == "featureSection"] | order(_createdAt asc) {    _id,    _type,    subheading,    title,    description,      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  "alt": coalesce(    alt,    asset->altText,    caption,    asset->originalFilename,    "untitled"  ),  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },    primaryButton,    secondaryButton,    imagePosition,    backgroundColor  }
export type QueryFeatureSectionsResult = Array<{
  _id: string;
  _type: "featureSection";
  subheading: null;
  title: string | null;
  ...
  backgroundColor: "cream" | "gray" | "white" | null;
}>;
